...
function EntityManager(core) {
  ...
  if (core.validators && core.validators.registered('entity') === false) {
    ...
    core.validators.register(
      'entities',
      loader('Entity/EntityManager/Validators/Entities')
    );
  }
  ...
  if (core.sanitizers && core.sanitizers.registered('entity') === false) {
    core.sanitizers.register(
      'entity',
      loader('Entity/EntityManager/Sanitizers/Entity')
    );

    core.sanitizers.register(
      'entities',
      loader('Entity/EntityManager/Sanitizers/Entities')
    );
  }
}
 ...
 */
EntityManager.prototype.schemas = function (done) {
  'use strict';
 ...
 */
EntityManager.prototype.schema = function (name, done) {
  'use strict';
 ...
 */
EntityManager.prototype.exists = function (type, machineName, done) {
  'use strict';
 ...
 */
EntityManager.prototype.count = function (type, done) {
  'use strict';
 ...
 */
EntityManager.prototype.create = function (done, type, subtype) {
  'use strict';
 ...
 */
EntityManager.prototype.load = function (type, machineName, done, force) {
  'use strict';
 ...
 */
EntityManager.prototype.find = function (type, conditions, done, per, page) {
  'use strict';
...
/**
 * Exports the EntityManager class.
 */
